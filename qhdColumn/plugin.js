...
(function()
{
	...
	function inserColumn( editor, columnClass ){
		...
		if( getDivElementByClass(editor, 'qhd-content') != null ){
		...
		{	
			...
			if ( editor.addMenuItems )
			{
				...
				{	
					...
					modifyQhdColumnMarg :
					{
						...
						getItems : function()
						{
							return {
								...
								modifyQhdColumnMarg_3 : CKEDITOR.TRISTATE_OFF,
					...
					modifyQhdColumnMarg_3 :
					{
						label : '多列的间距 - 3%',
						//icon: this.path + 'removeColumn.png',
						group : 'modifyQhdColumnMarg',
						onClick : function() { modifyQhdColumnMarg( editor, ''); }
					},
